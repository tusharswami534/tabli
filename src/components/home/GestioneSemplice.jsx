...
const GestioneSemplice = () => {
  return (
    <div className="bg-dark-blue relative overflow-x-clip">
      <Image className='w-full max-w-[292px] pointer-events-none sm:max-w-[400px] xl:max-w-[585px] absolute -translate-x-[50%] left-[50%] -top-9 lg:-top-4 z-50' height={158} width={585} src={'/assets/images/png/blue-3-tabli.png'} alt='top layer' />
      <Image className='w-full object-cover pointer-events-none -translate-y-1' height={217} width={1920} src={'/assets/images/png/gestione-top-layer.png'} alt='top layer' />
      <div className='flex max-md:flex-col-reverse max-sm:pb-[214px] max-xl:pb-16 max-lg:gap-4 max-sm:px-0 max-2xl:px-5 max-w-[1440px] mx-auto items-center justify-between pt-10 md:pt-[110px]'>
        ...
        <div>
          <Image className='max-xl:w-[400px] pointer-events-none 2xl:translate-y-7 max-2xl:w-[500px] h-[380px] xl:h-[480px] max-sm:w-[414px] max-sm:h-[396px] max-sm:translate-x-14 2xl:h-[586px] ' height={620} width={619} src={'/assets/images/png/gestione-main.png'} alt='side img' />
        </div>
      </div>
      <Image className='absolute sm:hidden left-[50%] top-[-8%] translate-x-[-50%] pointer-events-none' height={1440} width={633} src={'/assets/images/png/sm-screen-lines.png'} alt='summer ticket' />
      <Image className='absolute pointer-events-none -bottom-6 sm:hidden left-0' height={190} width={152} src={'/assets/images/png/summer-ticket-one.png'} alt='summer ticket' />
      <Image className='absolute pointer-events-none bottom-8 sm:hidden -right-18' height={190} width={152} src={'/assets/images/png/summer-ticket-two.png'} alt='summer ticket' />
      <Image className='w-full pointer-events-none max-sm:h-[73px]' height={136} width={1920} src={'/assets/images/png/gestione-bottom-layer.png'} alt='bottom layer' />
    </div>
  )
}
