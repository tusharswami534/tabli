  ...
  return (
    <div className="bg-dark-blue relative overflow-hidden">
      ...
      <div className='flex max-md:flex-col-reverse max-lg:gap-4  max-2xl:px-5 max-w-[1440px] mx-auto items-center justify-between pt-[110px] pb-[97px] '>
        <div className="">
          <Image className='absolute left-[-40%] max-lg:hidden xl:left-[-20%] 2xl:left-0 top-[100px] xl:top-[180px] pointer-events-none' height={759} width={1006} src={'/assets/images/png/gestione-side-line.png'} alt='side line' />
