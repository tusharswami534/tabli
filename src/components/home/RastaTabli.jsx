...
const RastaTabli = () => {
    ...
    return (
        <div className='bg-dark-blue relative max-md:overflow-hidden md:overflow-x-clip pt-[255px] md:pt-[455px] pb-[175px] lg:pb-[200px] 2xl:pb-[490px] mt-[-1px]'>
            <Image className='absolute pointer-events-none top-[200px] md:hidden' height={1440} width={613} src={'/assets/images/png/sm-food-line.png'} alt='food cover line' />
            <Image className='absolute pointer-events-none left-[0px] max-xl:hidden top-[600px] 2xl:top-[520px] h-[700px] 2xl:h-[1195px] z-0' height={1100} width={1000} src={'/assets/images/png/food-cover-line.png'} alt='line layer' />
            <Image className='w-full pointer-events-none max-sm:h-[73px] absolute -top-1 -translate-y-0.5 z-10' height={136} width={1920} src={'/assets/images/png/more-info-bottom-layer.png'} alt='bottom layer' />
            <div className='absolute pointer-events-none left-[-2%] top-10 md:-top-[50px] xl:-top-[100px] z-20'>
            ...
            <div className="container max-w-[1200px] mx-auto md:px-4 relative z-30">
                <div className="text-white text-center p-6 rounded-lg max-w-[670px] max-xl:mx-auto ml-auto">
                    <p className="!text-white !max-w-[622px] !leading-130 font-black md:text-40 text-32 italic relative"> <span className='relative z-10'>Resta aggiornato su Tabli, il lancio è dietro l’angolo!</span> <span className='absolute top-1 left-1 z-0 text-teal-900 font-extrabold opacity-30'>Resta aggiornato su Tabli, il lancio è dietro l’angolo!</span></p>
            ...
            <div className='absolute z-10 2xl:bottom-[-3%] xl:bottom-[-8%] md:bottom-[-6%] bottom-[-1%] sm:left-[7%] left-[14%] '>
                <Image src="/assets/images/webp/menu.webp" alt='menu' width={729} height={517} className='2xl:w-[825px] xl:w-[600px] pointer-events-none lg:w-[300px] md:w-[250px] w-[236px]' />
            </div>
        </div>
    )
}
