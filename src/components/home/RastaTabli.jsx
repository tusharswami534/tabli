...
const RastaTabli = () => {
    ...
    return (
        <div className='bg-dark-blue relative max-md:overflow-hidden md:overflow-x-clip pt-[255px] md:pt-[455px] pb-[175px] lg:pb-[200px] 2xl:pb-[490px] mt-[-1px]'>
            ...
            <Image className='absolute pointer-events-none left-[0px] max-xl:hidden top-[600px] 2xl:top-[520px] h-[700px] 2xl:h-[1200px] z-0' height={1100} width={1000} src={'/assets/images/png/food-cover-line.png'} alt='line layer' />
