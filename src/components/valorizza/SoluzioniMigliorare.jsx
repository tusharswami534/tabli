...
const SoluzioniMigliorare = () => {
  return (
    <div>
      <div className="bg-dark-blue relative -mt-1 pt-10">
        ...
        <div className="max-w-[1560px] mx-auto px-4">
          <div className="flex max-lg:flex-col lg:gap-20 gap-10 max-xl:justify-center pt-10 xl:pb-[100px] md:pb-20 relative z-10 max-w-[1408px] mx-auto">
            ...
            <div>
              <Heading headingText="  Soluzioni per migliorare il tuo lavoro" className="!text-center lg:!max-w-[465px] max-lg:!text-center max-sm:!text-left !max-w-none max-lg:!text-40 !leading-normal !text-yellow xl:!pb-10 !pb-6" />
