  ...
  return (
    <div>
      <div className="bg-dark-blue relative -mt-1 md:pt-10">
        <Image className="absolute xl:-top-[13%] lg:top-[-15%] md:-top-[11%] sm:-top-[9%] !top-[-4%] max-[700px]:top-[-5%]] md:h-[136px] sm:h-[94px] h-[67px]  w-full" src="/assets/images/png/Soluzioni-top-layer.png" alt="top-layer" width={1920} height={136} />
