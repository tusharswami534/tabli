      ...
      <div className="bg-dark-blue relative -mt-1 md:pt-10">
        ...
        <div className="max-w-[1560px] mx-auto px-6 max-sm:pb-3">
          <div className="flex max-lg:flex-col lg:gap-20 gap-10 max-xl:justify-center pt-10 lg:pb-[100px] mb:pb-20 relative z-10 max-w-[1408px] mx-auto">
            <Image className="xl:max-w-[656px] xl:h-[640px] lg:max-w-[427px] pointer-events-none md:max-w-[467px] max-w-[350px] w-full md:h-[500px] max-lg:mx-auto" src="/assets/images/webp/soluzioni.webp" alt="soluzioni-image" width={656} height={640} />
            <div>
