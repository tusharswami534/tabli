...
const SoluzioniMigliorare = () => {
  return (
    <div>
      <div className='bg-[#136F77] relative -mt-1 pt-10'>
        ...
        <Image className='absolute h-auto left-0 w-[260px] lg:block hidden top-[5%]' src="/assets/images/png/soluzioni-left-layer.png" alt='top-layer' width={1920} height={136} />
        <Image className='absolute h-auto right-0 w-[379px] lg:block hidden ' src="/assets/images/png/soluzioni-right-layer.png" alt='bottom-layer' width={1920} height={152} />
        <div className="max-w-[1408px] mx-auto px-4">
          <div className="flex max-lg:flex-col gap-20 max-lg:justify-center pt-10 pb-[100px] relative z-10 max-w-[1408px] mx-auto">
           <Image className=' xl:max-w-[656px] xl:h-[640px] md:max-w-[427px] w-full md:h-[500px]' src="/assets/images/png/soluzioni.png" alt='soluzioni-image' width={656} height={640}/>
            <div>
