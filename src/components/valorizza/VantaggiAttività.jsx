...
const VantaggiAttività = () => {
    ...
    return (
        <div className='bg-dark-blue relative pt-10 '>
            <Image src="/assets/images/webp/outline.webp" alt='outline' width={1920} height={1080} className='w-full absolute 2xl:bottom-[-31%] min-[1200px]:-bottom-[21%] z-20  h-auto xl:block hidden' />
            ...
            <Image src="/assets/images/webp/tabli-yellow .webp" alt='tabli name' width={585} height={158} className=' absolute lg:bottom-[-8%] md:bottom-[-9%] bottom-[-5%] xl:left-[30%] lg:left-[18%] md:left-[10%] left-[9%] max-w-[585px] mx-auto w-full z-20 max-sm:w-[292px] min-[2000px]:!left-[45%]' />
            ...
            <div className="max-w-[1408px] mx-auto px-4">
                ...
                <div className="flex max-lg:flex-col lg:justify-between relative z-30 max-lg:justify-center md:pt-10 md:pb-[140px] pb-20 max-w-[1408px] mx-auto">
