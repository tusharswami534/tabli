...
const VantaggiAttività = () => {
    ...
    return (
        <div className='bg-dark-blue relative pt-8 sm:pt-10 2xl:pt-4 '>
            <Image src="/assets/images/png/attivita-left-layer.png" alt='tabli name' width={685} height={1258} className=' absolute z-30 2xl:max-w-[680px] max-w-[500px] 2xl:min-h-[1065px] xl:block !overflow-hidden hidden min-h-[900px] 2xl:top-[-8%] left-0' />
            <Image src="/assets/images/png/attivita-right-layer.png" alt='tabli name' width={920} height={1258} className='min-[1720px]:!max-w-[920px] 2xl:max-w-[770px] xl:max-w-[620px] xl:block hidden !overflow-hidden min-h-[950px] h-auto absolute z-20 right-0 2xl:top-[13%] top-[17%]' />
