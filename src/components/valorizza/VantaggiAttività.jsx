...
const VantaggiAttività = () => {
    ...
    return (
        <div className='bg-dark-blue relative pt-4 sm:pt-10 2xl:pt-4 '>
            <Image src="/assets/images/webp/outline.webp" alt='outline' width={1920} height={1080} className='w-full absolute 2xl:bottom-[-15%] min-[1200px]:-bottom-[19%] z-20  h-auto xl:block hidden min-[2000px]:!bottom-[-45%]' />
            ...
            <Image src="/assets/images/webp/tabli-yellow .webp" alt='tabli name' width={585} height={158} className=' absolute lg:bottom-[-11%] md:bottom-[-9%] bottom-[-5%] max-w-[585px] mx-auto w-full max-[768px]:top-[90%] max-[650px]:top-[95%] max-[400px]:top-[98%] z-20 max-sm:w-[292px] left-1/2 -translate-x-1/2' />
