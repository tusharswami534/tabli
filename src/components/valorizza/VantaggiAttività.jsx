...
const VantaggiAttività = () => {
    ...
    return (
        <div className='bg-dark-blue relative pt-10 '>
            ...
            <Image src="/assets/images/webp/tabli-yellow .webp" alt='tabli name' width={585} height={158} className=' absolute lg:bottom-[-8%] md:bottom-[-9%] bottom-[-5%] xl:left-[30%] lg:left-[18%] md:left-[10%] left-[9%] max-w-[585px] mx-auto w-full max-sm:top-[100%] z-20 max-sm:w-[292px] min-[2000px]:!left-[45%]' />
