...
const VantaggiAttività = () => {
    return (
        <div className='bg-dark-blue relative pt-10'>
            {/* <Image src="/assets/images/png/attivita-right-layer.png" alt='outline' width={1920} height={1080} className='w-full absolute 2xl:bottom-[-35%] bottom-[-15%]  h-auto xl:block hidden' />
            <Image src="/assets/images/png/attivita-left-layer.png" alt='tabli name' width={585} height={158} className=' absolute lg:top-[-23%] md:top-[-19%] top-[-10%] xl:left-[30%] lg:left-[18%] md:left-[10%] left-[9%] max-w-[585px] mx-auto w-full max-sm:w-[292px]' /> */}
            ...
            <div className="max-w-[1408px] mx-auto px-4">
                ...
                <div className="flex max-lg:flex-col lg:justify-between relative z-10 max-lg:justify-center pt-10 md:pb-[140px] pb-24 max-w-[1408px] mx-auto">
