            ...
            <div className='flex items-center gap-5 max-lg:gap-0 max-[1100px]:flex-col justify-between'>
              <div className='flex flex-col max-w-[726px] max-lg:px-4 relative z-[2] w-full min-[1100px]:w-6/12'>
                ...
                <div className='flex gap-4 mt-10 max-sm:flex-col max-[1100px]:items-center max-[1100px]:justify-center'>
                  ...
                  <CustomButton customOnClick={() => setActiveButton('contatti')} buttonName={'Contatti'} className={`max-w-[160px] whitespace-nowrap leading-119 max-sm:max-w-[280px] w-full border border-solid !text-dark-blue ${activeButton === 'contatti' ? '!text-white !border-white !bg-dark-blue' : '!bg-white'} ${path === '/' ? '!border-dark-blue hover:!text-white hover:!bg-dark-grey' : '!border-dark-blue hover:!bg-dark-grey hover:!text-white'} `} />
                </div>
              </div>
                    ...
                    {HERO_SWIPER_DATA.map((obj, index) => {
                      return (
                        <SwiperSlide key={index}>
                          <div className="py-14 max-[1100px]:justify-center xl:py-[79px] flex justify-end">
                            <Image
                              src={obj.image}
                              alt="hero-image"
                              width={197}
